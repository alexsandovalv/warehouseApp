package pe.edu.upc.warehouse.storage.preferences;
...
public class PreferencesHelper {
    ...
    private static final String WAREHOUSE_PREFERENCES = "mynotesPreferences";
    private static final String PREFERENCES_USERNAME = WAREHOUSE_PREFERENCES + ".username";
    private static final String PREFERENCES_PASSWORD = WAREHOUSE_PREFERENCES + ".password";
    private static final String PREFERENCES_TOKEN = WAREHOUSE_PREFERENCES + ".token";
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        return context.getSharedPreferences(WAREHOUSE_PREFERENCES, Context.MODE_PRIVATE);
    }
